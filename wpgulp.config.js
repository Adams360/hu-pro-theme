...
module.exports = {
	...
	// Project options.
	projectURL: 'hackerupro/', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	imgDST: './dist/assets/img/', // Destination folder of optimized images. Must be different from the imagesSRC folder.

	// Watch files paths.
	watchStyles: './sass/**/*.scss', // Path to all *.scss files inside css folder and inside them.
	watchJsVendor: './assets/vendor/js/*.js', // Path to all vendor JS files.
